...
using AppOwnsData.Models.Enums;

namespace AppOwnsData.Data
{
    public class SeedingService
    {
        private AppOwnsDataContext _context;

        public SeedingService(AppOwnsDataContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s6 = new Seller(6, "Alex Pink", "donald@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
